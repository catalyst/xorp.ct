...
// $XORP: xorp/fea/data_plane/firewall/firewall_get_netfilter.hh,v 1.3 2008/10/02 21:57:03 bms Exp $

#ifndef __FEA_DATA_PLANE_FIREWALL_FIREWALL_GET_NETFILTER_HH__
#define __FEA_DATA_PLANE_FIREWALL_FIREWALL_GET_NETFILTER_HH__

#include "fea/firewall_get.hh"


class FirewallGetNetfilter : public FirewallGet 
{
	public:
		/**
		 * Constructor.
		 ...
		 */
		FirewallGetNetfilter(FeaDataPlaneManager& fea_data_plane_manager);

		/**
		 * Virtual destructor.
		 */
		virtual ~FirewallGetNetfilter();
...
#endif // __FEA_DATA_PLANE_FIREWALL_FIREWALL_GET_NETFILTER_HH__
